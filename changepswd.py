...
class Ui_RemoteInstall(object):
    def setupUi(self, RemoteInstall):
        ...
        # self.lineEdit_6.setGeometry(QtCore.QRect(460, 280, 471, 31))
...
""))
        ...
        self.label_9.setText(_translate("RemoteInstall", "Введите новый пароль")) #Скрипт должен быть "вида net user it_dep passwd
